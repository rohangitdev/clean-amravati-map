          ...
          <Link href="/dashboard" className="flex items-center gap-2">
            <div className="w-7 h-7 bg-green-600 rounded-md flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path
                  d="M8 1.5C4.96 1.5 2.5 3.96 2.5 7C2.5 10.04 4.96 12.5 8 12.5C11.04 12.5 13.5 10.04 13.5 7C13.5 3.96 11.04 1.5 8 1.5ZM8 11.5C5.51 11.5 3.5 9.49 3.5 7C3.5 4.51 5.51 2.5 8 2.5C10.49 2.5 12.5 4.51 12.5 7C12.5 9.49 10.49 11.5 8 11.5Z"
                  fill="white"
                />
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <rect
              ...
              height="7"
              rx="1.5"
              fill={router.pathname === "/dashboard" ? "#16a34a" : "#94a3b8"}
            />
            <rect
              x="11"
              y="2"
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <rect
              ...
              height="5"
              rx="1"
              fill={router.pathname === "/leaderboard" ? "#16a34a" : "#94a3b8"}
            />
            <rect
              x="8"
              y="8"
